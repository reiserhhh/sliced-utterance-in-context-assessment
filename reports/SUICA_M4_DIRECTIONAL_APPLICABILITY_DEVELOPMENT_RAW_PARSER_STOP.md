...
`M4_C35_DIRECTIONAL_INTEGRITY_STOP`
...
- `integrity`: {"main_cells": 360, "maximum_basis_replay_error": 0.0, "maximum_null_absolute_gain": NaN, "maximum_response_identity_error": 0.0, "maximum_signature_replay_error": 0.0, "null_cells": 0, "sealed_cells": 432}
...
Integrity or null controls failed; no policy result is interpretable.
